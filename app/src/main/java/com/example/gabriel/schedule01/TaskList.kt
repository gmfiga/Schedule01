...
class TaskList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lv.setOnItemClickListener { parent, view, position, id ->
            ...
            Toast.makeText(this@TaskList, "You have bite Clicked " + position, Toast.LENGTH_SHORT).show()
            showSimpleAlert()
        }
    ...
    private fun showSimpleAlert() {
        ...
        val simpleAlert = AlertDialog.Builder(this@TaskList).create()
    ...
    fun editTask(position: Int){
        ...
        val randomIntent = Intent(this, TaskEditor::class.java)

        randomIntent.putExtra(TaskEditor.DESCRIPTION_TEXT, task?.description)
        randomIntent.putExtra(TaskEditor.DATE, task?.date)
        randomIntent.putExtra(TaskEditor.HOUR, task?.hour)
        randomIntent.putExtra(TaskEditor.POSITIONTASK, stringpos)
        randomIntent.putExtra(TaskEditor.EDIT, 1)
