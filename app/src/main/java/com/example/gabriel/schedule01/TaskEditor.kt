...
class TaskEditor : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        timetext.setOnClickListener(object : View.OnClickListener {
            override  fun onClick(view: View){
                TimePickerDialog(this@TaskEditor, hourSetListener,
        ...
        datetext.setOnClickListener(object : View.OnClickListener   {
            override fun onClick(view: View){
                DatePickerDialog(this@TaskEditor, dateSetListener,
    ...
    fun submitMe(view: View){
        ...
        if (edit == 1)
            data.putExtra(TaskList.POSITION, intent.getStringExtra(POSITIONTASK))


        data.putExtra(TaskList.DESCRIPTION_TEXT, description?.text.toString())
        data.putExtra(TaskList.DATE, date?.text.toString())
        data.putExtra(TaskList.HOUR, hour?.text.toString())
